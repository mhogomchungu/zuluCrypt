...
void walletconfig::itemClicked_0( QTableWidgetItem * item )
{
	...
	auto r = msg.ShowUIYesNo( tr( "WARNING!" ),tr( "Are you sure you want to delete a volume with an id of \"%1\"?" ).arg( m_volumeID ) ) ;
...
void walletconfig::pbAdd()
{
	...
	walletconfiginput::instance( this,[ this ]( const QString& volumeID,const QString& comment,const QString& key ){
